...
public class TransactionService {
  ...
  public Mono<TransactionEntity> findById(Integer id) {
    return this.transactionRepository
        ...
        .flatMap(
            transactionEntity -> {
              return this.tagMapRepository
                  .findAllByTransactionId(transactionEntity.getId())
        ...
        .flatMap(
            tagEntity -> {
              return this.tagRepository
                  .findOneByName(tagEntity.getName())
        ...
        .flatMap(
            tagEntities -> {
              return this.transactionRepository
                  ...
                  .map(
                      savedTransaction -> {
                        return new Tuple<TransactionEntity, List<TagEntity>>(
                            savedTransaction, tagEntities);
                      });
            })
        .flatMap(
            tuple -> {
